...
/***/ "./api/album/getAlbumsTitles.js":
/*!**************************************!*\
  !*** ./api/album/getAlbumsTitles.js ***!
  \**************************************/
/***/ ((module) => {

eval("async function getAlbumTitles() {\n  const list = [];\n  const url = 'http://localhost:3000/albums';\n\n  const result = await fetch(url);\n  const data = await result.json();\n\n\n  data.forEach((album) => {\n    list.push([album.title]);\n  });\n\n  return list;\n}\n\nmodule.exports = getAlbumTitles;\n\n\n//# sourceURL=webpack://cd-manager/./api/album/getAlbumsTitles.js?");
...
eval("const getAlbumsHTML = __webpack_require__(/*! ./album/getAlbumsHTML.js */ \"./api/album/getAlbumsHTML.js\");\nconst getAlbumByID = __webpack_require__(/*! ./album/getAlbumByID.js */ \"./api/album/getAlbumByID.js\");\nconst getAlbumTitles = __webpack_require__(/*! ./album/getAlbumsTitles.js */ \"./api/album/getAlbumsTitles.js\");\nconst addAlbumToCollection = __webpack_require__(/*! ./album/addAlbum.js */ \"./api/album/addAlbum.js\");\nconst getCDsHTML = __webpack_require__(/*! ./cd/cdsHTML.js */ \"./api/cd/cdsHTML.js\");\nconst getCDByID = __webpack_require__(/*! ./cd/getCDByID.js */ \"./api/cd/getCDByID.js\");\nconst getCDTitles = __webpack_require__(/*! ./cd/CDsTitles.js */ \"./api/cd/CDsTitles.js\");\nconst addCDToCollection = __webpack_require__(/*! ./album/addAlbum.js */ \"./api/album/addAlbum.js\");\nconst getTracksHTML = __webpack_require__(/*! ./track/tracksHTML.js */ \"./api/track/tracksHTML.js\");\nconst getTrackbyID = __webpack_require__(/*! ./track/getTrackByID.js */ \"./api/track/getTrackByID.js\");\nconst updateAlbum = __webpack_require__(/*! ./album/updateAlbum.js */ \"./api/album/updateAlbum.js\");\nconst updateCD = __webpack_require__(/*! ./cd/updateCD.js */ \"./api/cd/updateCD.js\");\nconst updateTrack = __webpack_require__(/*! ./track/updateTrack.js */ \"./api/track/updateTrack.js\");\n\nmodule.exports = {\n  getAlbumsHTML,\n  getAlbumByID,\n  getAlbumTitles,\n  addAlbumToCollection,\n  getCDsHTML,\n  getCDByID,\n  getCDTitles,\n  addCDToCollection,\n  getTracksHTML,\n  getTrackbyID,\n  updateAlbum,\n  updateCD,\n  updateTrack,\n};\n\n\n//# sourceURL=webpack://cd-manager/./api/index.js?");
...
eval("const { clearContentHolders, setTitle } = __webpack_require__(/*! ../../components/index.js */ \"./src/components/index.js\");\nconst searchCDForm = __webpack_require__(/*! ../../components/forms/cd/editCDSearch.js */ \"./src/components/forms/cd/editCDSearch.js\");\n\nfunction buildCDsEditPage() {\n\n  clearContentHolders();\n\n  setTitle('Edit a CD');\n\n  searchCDForm();\n\n}\n\nmodule.exports = buildCDsEditPage;\n\n\n//# sourceURL=webpack://cd-manager/./src/pages/cds/editCD.js?");
