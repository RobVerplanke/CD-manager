...
/***/ "./api/getAllAlbumsList.js":
/*!*********************************!*\
  !*** ./api/getAllAlbumsList.js ***!
  \*********************************/
/***/ ((module) => {

eval("async function renderAlbumssList() {\n  const list = [];\n  const url = 'http://localhost:3000/albums';\n\n  const result = await fetch(url);\n  const data = await result.json();\n\n\n  data.forEach((album) => {\n    list.push([album.title]);\n  });\n\n  return list;\n}\n\nmodule.exports = renderAlbumssList;\n\n\n//# sourceURL=webpack://cd-manager/./api/getAllAlbumsList.js?");

/***/ }),

/***/ "./api/getAllCDsList.js":
/*!******************************!*\
  !*** ./api/getAllCDsList.js ***!
  \******************************/
/***/ ((module) => {

eval("async function renderCDsList() {\n  const list = [];\n  const url = 'http://localhost:3000/cds';\n\n  const result = await fetch(url);\n  const data = await result.json();\n\n\n  data.forEach((cd) => {\n    list.push([cd.title]);\n  });\n\n  return list;\n}\n\nmodule.exports = renderCDsList;\n\n\n//# sourceURL=webpack://cd-manager/./api/getAllCDsList.js?");
